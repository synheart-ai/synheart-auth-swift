...
Thank you for taking the time to look at Synheart Auth (Swift). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-auth-swift/issues) to avoid
   duplicates.
