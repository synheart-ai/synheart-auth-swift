...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/synheart-ai/synheart-auth-swift)
...
```swift
dependencies: [
    .package(url: "https://github.com/synheart-ai/synheart-auth-swift.git", from: "1.0.0"),
]
```
...
SynheartAuth.shared.configure(baseUrl: "https://auth.synheart.ai")
