...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-auth-swift/security/advisories/new).
...
This policy covers the `SynheartAuth` SDK published from this repository. Issues
